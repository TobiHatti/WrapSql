...
namespace WrapSql
{
    ...
    /// </summary>
    public class WrapOleDb : WrapSqlBase<OleDbDataReader, OleDbDataAdapter>
    {
        /// <summary>
        ...
        ///<inheritdoc/>
        protected override OleDbDataReader ExecuteQueryImplement(string sqlQuery, params object[] parameters)
        {
        ...
        ///<inheritdoc/>
        protected override OleDbDataAdapter GetDataAdapterImplement(string sqlQuery, params object[] parameters)
        {
            using (OleDbCommand command = new OleDbCommand(sqlQuery, (OleDbConnection)Connection))
            {
                foreach (object parameter in parameters) command.Parameters.AddWithValue(string.Empty, parameter);
