...
namespace WrapSql
{
    ...
    /// WrapSQL base class.
    /// </summary>
    public abstract class WrapSqlBase<TDataReader, TDataAdapter> : IDisposable, IWrapSql where TDataReader : DbDataReader where TDataAdapter : DataAdapter
    {
        #region Fields
        ...
        protected abstract TDataReader ExecuteQueryImplement(string sqlQuery, params object[] parameters);
        ...
        /// <param name="parameters">Query-parameters</param>
        /// <returns>DataReader fetching the query-results</returns>
        private TDataReader ExecuteQueryManaged(string sqlQuery, params object[] parameters)
        {
            try
            {
                TDataReader dbResult = ExecuteQueryImplement(sqlQuery, parameters);
                LastErrorCode = WrapSqlErrorCode.Success;
                return dbResult;
            }
            catch (Exception ex)
        ...
        /// <param name="parameters">Query-parameters</param>
        /// <returns>DataReader fetching the query-results</returns>
        public TDataReader ExecuteQuery(string sqlQuery, params object[] parameters) => ExecuteQueryManaged(sqlQuery, parameters);
        ...
        protected abstract TDataAdapter GetDataAdapterImplement(string sqlQuery, params object[] parameters);
        ...
        /// <param name="parameters">Query-parameters</param>
        /// <returns>DataAdapter of the given query-statement</returns>
        private TDataAdapter GetDataAdapterHandled(string sqlQuery, params object[] parameters)
        {
            try
            {
                TDataAdapter dbResult = GetDataAdapterImplement(sqlQuery, parameters);
                LastErrorCode = WrapSqlErrorCode.Success;
                return dbResult;
            }
            catch (Exception ex)
        ...
        /// <param name="parameters">Query-parameters</param>
        /// <returns>DataAdapter of the given query-statement</returns>
        public TDataAdapter GetDataAdapter(string sqlQuery, params object[] parameters) => GetDataAdapterHandled(sqlQuery, parameters);
