...
namespace WrapSQL
{
    public class WrapOleDb : WrapSQL
    {
        ...
        public OleDbDataReader ExecuteQuery(string sqlQuery, params object[] parameters)
        {
        ...
        public OleDbDataAdapter GetDataAdapter(string sqlQuery, params object[] parameters)
        {
            using (OleDbCommand command = new OleDbCommand(sqlQuery, Connection))
            {
                foreach (object parameter in parameters) command.Parameters.AddWithValue(string.Empty, parameter);
